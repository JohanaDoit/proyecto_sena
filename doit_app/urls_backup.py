...
urlpatterns = [
    ...
    path('experto/calendario/', views.calendario_experto, name='calendario_experto'), # Nueva vista del calendario
    path('experto/guardar-disponibilidad/', views.guardar_disponibilidad, name='guardar_disponibilidad'), # Nueva
    path('experto/obtener-disponibilidad/', views.obtener_disponibilidad, name='obtener_disponibilidad'), # Nueva
